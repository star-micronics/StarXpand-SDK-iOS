...
- (void)readWithSize:(NSInteger)size completion:(void (^ _Nonnull)(NSData * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=13.0,message="Not available on iOS 13 or later: Please use read(size:) async. This deprecated warning also appears when the iOS deployment target is set to iOS 12, but this method works properly on iOS 12.");
