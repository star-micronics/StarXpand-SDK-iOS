...
- (void)openWithCompletion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use open() async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
- (void)closeWithCompletion:(void (^ _Nonnull)(void))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use close() async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
- (void)readWithSize:(NSInteger)size completion:(void (^ _Nonnull)(NSData * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use read(size:) async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
- (void)printWithRaw:(NSData * _Nonnull)raw completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use print(raw:) async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
- (void)printWithCommand:(NSString * _Nonnull)command completion:(void (^ _Nonnull)(NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use print(command:) async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
- (void)getStatusWithCompletion:(void (^ _Nonnull)(STARIO10StarPrinterStatus * _Nullable, NSError * _Nullable))completion SWIFT_AVAILABILITY(ios,deprecated=12.0,obsoleted=15.0,message="Not available on iOS 15 or later: Please use getStatus() async. This deprecated warning also appears when the iOS deployment target is set to iOS 12-14, but this method works properly on iOS 12-14.");
@end
...
typedef SWIFT_ENUM_NAMED(NSInteger, STARIO10StarPrinterModel, "StarPrinterModel", open) {
  ...
  STARIO10StarPrinterModelTSP100IIIW SWIFT_COMPILE_NAME("tsp100IIIW") = 4,
  ...
  STARIO10StarPrinterModelSM_S210i SWIFT_COMPILE_NAME("sm_S210i") = 12,
  STARIO10StarPrinterModelSM_S230i SWIFT_COMPILE_NAME("sm_S230i") = 13,
  STARIO10StarPrinterModelSM_T300i SWIFT_COMPILE_NAME("sm_T300i") = 14,
  STARIO10StarPrinterModelSM_T400i SWIFT_COMPILE_NAME("sm_T400i") = 15,
  STARIO10StarPrinterModelSM_L200 SWIFT_COMPILE_NAME("sm_L200") = 16,
  STARIO10StarPrinterModelSM_L300 SWIFT_COMPILE_NAME("sm_L300") = 17,
  STARIO10StarPrinterModelSP700 SWIFT_COMPILE_NAME("sp700") = 18,
};
