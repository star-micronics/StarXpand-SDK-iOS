//
//  Sample13_JapaneseFoodLabelCake.swift
//  StarXpandSDK
//
...
class Sample13_JapaneseFoodLabelCake {
    static func createJapaneseFoodLabelCake() -> String {
        guard let plasticImage = UIImage(named: "sample13_japanese_food_label_lunch_cake_plastic.png") else {
            print("Failed to load \"sample13_japanese_food_label_lunch_cake_plastic.png\".")
            return ""
        }
