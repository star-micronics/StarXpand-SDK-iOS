//
//  LabelSample32_Sale50PercentOff_Template.swift
//  StarXpandSDK
//
...
class LabelSample32_Sale50PercentOff_Template {
    static func createLabelTemplate() -> String {
        guard let backgroundImage = UIImage(named: "label_sample32_sale_50off_background.png") else {
            print("Failed to load \"label_sample32_sale_50off_background.png\".")
            return ""
        }
