//
//  LabelSample28_CleanedAndSanitised_Template.swift
//  StarXpandSDK
//
...
class LabelSample28_CleanedAndSanitised_Template {
    static func createLabelTemplate() -> String {
        guard let handImage = UIImage(named: "label_sample28_cleanedsanitised_hand.png") else {
            print("Failed to load \"label_sample28_cleanedsanitised_hand.png\".")
            return ""
        }
