//
//  LabelSample19_PharmacyMedication1_Template.swift
//  StarXpandSDK
//
...
class LabelSample19_PharmacyMedication1_Template {
    static func createLabelTemplate() -> String {
        guard let logoImage = UIImage(named: "label_sample19_pharmacy_medication1_logo.png") else {
            print("Failed to load \"label_sample19_pharmacy_medication1_logo.png\".")
            return ""
        }
