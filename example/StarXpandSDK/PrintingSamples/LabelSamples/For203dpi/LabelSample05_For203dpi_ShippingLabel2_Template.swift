...
class LabelSample05_For203dpi_ShippingLabel2_Template {
    static func createLabelTemplate() -> String {
        guard let logoImage = UIImage(named: "logo_01.png") else {
            print("Failed to load \"logo_01.png\".")
            return ""
        }
        guard let houseImage = UIImage(named: "shipping_label_house.png") else {
            print("Failed to load \"shipping_label_house.png\".")
            return ""
        }
        guard let phoneImage = UIImage(named: "shipping_label_phones_old.png") else {
            print("Failed to load \"shipping_label_phones_old.png\".")
            return ""
        }
