//
//  LabelSample16_JapaneseFoodLabelLunchBox_Template.swift
//  StarXpandSDK
//
...
class LabelSample16_JapaneseFoodLabelLunchBox_Template {
    static func createJapaneseFoodLabelLunchBox() -> String {
        guard let plasticImage = UIImage(named: "label_sample16_japanese_food_label_lunch_box_plastic.png") else {
            print("Failed to load \"label_sample16_japanese_food_label_lunch_box_plastic.png\".")
            return ""
        }
